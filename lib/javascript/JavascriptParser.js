...
class JavascriptParser {
	constructor(options, sourceType = "auto") {
		this.hooks = Object.freeze({
			...
			blockPreStatement: new SyncBailHook(["statement"]),
	...
	/**
	 * @param {HookMap<SyncBailHook<any[], any>>} hookMap hooks that should be called
	 * @param {ExportedVariableInfo} info variable info
	 * @param  {...any} args args for the hook
	...
	/**
	 * @param {TODO} expression an expression
